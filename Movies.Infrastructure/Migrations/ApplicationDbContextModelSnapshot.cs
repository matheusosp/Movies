...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieMovieRent", b =>
                {
                    b.Property<long>("MovieRentsId")
                        .HasColumnType("bigint");

                    b.Property<long>("MoviesId")
                        .HasColumnType("bigint");

                    b.HasKey("MovieRentsId", "MoviesId");
            ...
            modelBuilder.Entity("Movies.Domain.Entities.MovieRent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Movies.Domain.Entities.Tenant", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Movies.Domain.Entities.Tenant", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieMovieRent", b =>
                {
                    b.HasOne("Movies.Domain.Entities.MovieRent", null)
                        .WithMany()
                        .HasForeignKey("MovieRentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
